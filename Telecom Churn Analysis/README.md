...
1. **Data Cleaning** — Fixed TotalCharges data type, removed 11 null rows, dropped customerID
2. **Exploratory Data Analysis** — Investigated churn across contract type, tenure, internet service, and monthly charges
3. **Machine Learning Model** — Logistic Regression to predict churn and extract top churn drivers
4. **Dashboard** — Power BI dashboard summarizing all findings for business stakeholders
...
**Gowtham**  
B.E. Computer Science & Engineering (AI & Data Science)  
